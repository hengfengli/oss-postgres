...
---END---
---START---
CREATE TABLE gen_part (gemini_pk serial PRIMARY KEY, key1 integer NOT NULL, key2 integer NOT NULL) PARTITION BY list (key1);
---END---
---START---
...
CREATE TABLE t1 (gemini_pk serial PRIMARY KEY, f1 float8);
---END---
---START---
