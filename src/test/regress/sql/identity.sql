...
---END---
---START---
CREATE TABLE itest1 (_gemini_pk serial PRIMARY KEY, a integer GENERATED BY DEFAULT AS IDENTITY, b text);
---END---
---START---
CREATE TABLE itest2 (_gemini_pk serial PRIMARY KEY, a bigint GENERATED ALWAYS AS IDENTITY, b text);
---END---
---START---
CREATE TABLE itest3 (_gemini_pk serial PRIMARY KEY, a smallint GENERATED BY DEFAULT AS IDENTITY(START WITH 7 INCREMENT BY 5), b text);
---END---
---START---
...
-- CREATE TABLE itest_err_1 (_gemini_pk serial PRIMARY KEY, a text GENERATED BY DEFAULT AS IDENTITY);
---END---
---START---
CREATE TABLE itest_err_2 (_gemini_pk serial PRIMARY KEY, a integer GENERATED ALWAYS AS IDENTITY GENERATED BY DEFAULT AS IDENTITY);
---END---
---START---
CREATE TABLE itest_err_3 (_gemini_pk serial PRIMARY KEY, a integer DEFAULT 5 GENERATED BY DEFAULT AS IDENTITY);
---END---
---START---
CREATE TABLE itest_err_4 (_gemini_pk serial PRIMARY KEY, a serial GENERATED BY DEFAULT AS IDENTITY);
---END---
---START---
...
---END---
---START---
CREATE TABLE itest5 (_gemini_pk serial PRIMARY KEY, a integer GENERATED ALWAYS AS IDENTITY, b text);
---END---
---START---
...
---END---
---START---
CREATE TABLE itest10 (_gemini_pk serial PRIMARY KEY, a integer GENERATED BY DEFAULT AS IDENTITY, b text);
---END---
---START---
CREATE TABLE itest11 (_gemini_pk serial PRIMARY KEY, a integer GENERATED ALWAYS AS IDENTITY, b text);
---END---
---START---
...
---END---
---START---
CREATE TABLE itest13 (_gemini_pk serial PRIMARY KEY, a integer);
---END---
---START---
...
---END---
---START---
CREATE TABLE itest5 (_gemini_pk serial PRIMARY KEY, a serial, b text);
---END---
---START---
...
---END---
---START---
CREATE TABLE itest7 (_gemini_pk serial PRIMARY KEY, a integer GENERATED ALWAYS AS IDENTITY);
---END---
---START---
...
---END---
---START---
CREATE TABLE itest7a (_gemini_pk serial PRIMARY KEY, b text) INHERITS (itest7);
---END---
---START---
CREATE TABLE itest7b (_gemini_pk serial PRIMARY KEY, a integer);
---END---
---START---
CREATE TABLE itest7c (_gemini_pk serial PRIMARY KEY, a integer GENERATED ALWAYS AS IDENTITY) INHERITS (itest7b);
---END---
---START---
...
---END---
---START---
CREATE TABLE itest7d (_gemini_pk serial PRIMARY KEY, a integer NOT NULL);
---END---
---START---
CREATE TABLE itest7e (_gemini_pk serial PRIMARY KEY) INHERITS (itest7d);
---END---
---START---
...
---END---
---START---
CREATE TABLE itest8 (_gemini_pk serial PRIMARY KEY, a integer GENERATED ALWAYS AS IDENTITY, b text);
---END---
---START---
...
---END---
---START---
CREATE TABLE itest8 (_gemini_pk serial PRIMARY KEY, f1 integer);
---END---
---START---
ALTER TABLE itest8
...
---END---
---START---
CREATE TABLE itest12 OF itest_type (_gemini_pk serial PRIMARY KEY, f1 WITH OPTIONS GENERATED ALWAYS AS IDENTITY);
---END---
---START---
-- error
...
---END---
---START---
CREATE TABLE itest_parent (_gemini_pk serial PRIMARY KEY, f1 date NOT NULL, f2 text, f3 bigint) PARTITION BY range (f1);
---END---
---START---
...
---END---
---START---
CREATE TABLE itest14 (_gemini_pk serial PRIMARY KEY, id serial);
---END---
---START---
...
---END---
---START---
CREATE TABLE itest15 (_gemini_pk serial PRIMARY KEY, id integer GENERATED ALWAYS AS IDENTITY NULL);
---END---
---START---
CREATE TABLE itest15 (_gemini_pk serial PRIMARY KEY, id integer NULL GENERATED ALWAYS AS IDENTITY);
---END---
---START---
CREATE TABLE itest15 (_gemini_pk serial PRIMARY KEY, id integer GENERATED ALWAYS AS IDENTITY NOT NULL);
---END---
---START---
DROP TABLE itest15;
---END---
---START---
CREATE TABLE itest15 (_gemini_pk serial PRIMARY KEY, id integer NOT NULL GENERATED ALWAYS AS IDENTITY);
---END---
---START---
DROP TABLE itest15;
---END---
---START---
CREATE TABLE itest15 (_gemini_pk serial PRIMARY KEY, a integer GENERATED ALWAYS AS IDENTITY, b text);
---END---
---START---
CREATE TABLE itest16 (_gemini_pk serial PRIMARY KEY, a integer GENERATED BY DEFAULT AS IDENTITY, b text);
---END---
---START---
