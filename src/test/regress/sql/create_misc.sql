---START---
CREATE TABLE a_star (gemini_pk serial PRIMARY KEY, class char, a int4);
---END---
---START---
CREATE TABLE b_star (gemini_pk serial PRIMARY KEY, b text) INHERITS (a_star);
---END---
---START---
CREATE TABLE c_star (gemini_pk serial PRIMARY KEY, c name) INHERITS (a_star);
---END---
---START---
CREATE TABLE d_star (gemini_pk serial PRIMARY KEY, d float8) INHERITS (b_star, c_star);
---END---
---START---
CREATE TABLE e_star (gemini_pk serial PRIMARY KEY, e int2) INHERITS (c_star);
---END---
---START---
CREATE TABLE f_star (gemini_pk serial PRIMARY KEY, f polygon) INHERITS (e_star);
---END---
---START---
