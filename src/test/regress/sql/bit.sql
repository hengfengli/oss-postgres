---START---
CREATE TABLE bit_table (gemini_pk serial PRIMARY KEY, b pg_catalog.bit(11));
---END---
---START---
...
---END---
---START---
CREATE TABLE varbit_table (gemini_pk serial PRIMARY KEY, v bit varying(11));
---END---
---START---
...
---END---
---START---
CREATE TABLE bit_shift_table (gemini_pk serial PRIMARY KEY, b pg_catalog.bit(16));
---END---
---START---
...
---END---
---START---
CREATE TABLE varbit_shift_table (gemini_pk serial PRIMARY KEY, v bit varying(20));
---END---
---START---
...
---END---
---START---
CREATE TABLE bit_defaults (gemini_pk serial PRIMARY KEY, b1 pg_catalog.bit(4) DEFAULT '1001', b2 pg_catalog.bit(4) DEFAULT b'0101', b3 bit varying(5) DEFAULT '1001', b4 bit varying(5) DEFAULT b'0101');
---END---
---START---
\d bit_defaults
