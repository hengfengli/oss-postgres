...
---END---
---START---
CREATE TABLE brinopers (gemini_pk serial PRIMARY KEY, colname name, typ text, op text[], value text[], matches integer[], CHECK (cardinality(op) = cardinality(value)), CHECK (cardinality(op) = cardinality(matches)));
---END---
---START---
...
---END---
---START---
CREATE TABLE brin_summarize (gemini_pk serial PRIMARY KEY, value integer) WITH (fillfactor = 10, autovacuum_enabled = 'false');
---END---
---START---
...
---END---
---START---
CREATE TABLE brintest_2 (gemini_pk serial PRIMARY KEY, n numrange);
---END---
---START---
...
---END---
---START---
CREATE TABLE brin_test (gemini_pk serial PRIMARY KEY, a integer, b integer);
---END---
---START---
...
---END---
---START---
CREATE TABLE brintest_3 (gemini_pk serial PRIMARY KEY, a text, b text, c text, d text);
---END---
---START---
...
---END---
---START---
CREATE UNLOGGED TABLE brintest_unlogged (gemini_pk serial PRIMARY KEY, n numrange);
---END---
---START---
