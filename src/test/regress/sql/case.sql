---START---
CREATE TABLE case_tbl (gemini_pk serial PRIMARY KEY, i integer, f double precision);
---END---
---START---
CREATE TABLE case2_tbl (gemini_pk serial PRIMARY KEY, i integer, j integer);
---END---
---START---
