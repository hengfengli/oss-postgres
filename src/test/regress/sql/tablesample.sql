---START---
CREATE TABLE test_tablesample (gemini_pk serial PRIMARY KEY, id integer, name text) WITH (fillfactor = 10);
---END---
---START---
...
---END---
---START---
CREATE TABLE parted_sample (gemini_pk serial PRIMARY KEY, a integer) PARTITION BY list (a);
---END---
---START---
