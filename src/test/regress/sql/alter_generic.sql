...
---END---
---START---
CREATE TABLE alt_regress_1 (gemini_pk serial PRIMARY KEY, a integer, b integer);
---END---
---START---
...
---END---
---START---
CREATE TABLE alt_regress_2 (gemini_pk serial PRIMARY KEY, a integer, b integer);
---END---
---START---
